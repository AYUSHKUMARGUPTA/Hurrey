...
@Component({
  selector: 'app-custom-kendo-multiselect-filter',
  templateUrl: './custom-kendo-multiselect-filter.component.html',
  styleUrls: ['./custom-kendo-multiselect-filter.component.css']
})
export class CustomKendoMultiselectFilterComponent implements OnInit {
